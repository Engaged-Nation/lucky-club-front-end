<?php require_once __DIR__ . '/../../lucky-club-portal/vendor/engaged-nation/portal-core/FrontEnd/Bootstrap/client-front-end.php'; ?>
<!DOCTYPE html>
<html lang="en">
<head>
    <title>VIP Preferred at Lucky Club Hotel & Casino</title>
    <?php require_once __DIR__ . '/../../lucky-club-portal/vendor/engaged-nation/portal-core/GoogleTagManager/Resources/public/gtm.php'; ?>
...
<body>
    ...
    <script src="//<?php echo $enConfigClient['environment']['site_portal']; ?>/lib/js/engage.php?client_name=lucky-club&client_id=3facff723969f64585f8fcdeacf6da34" type="text/javascript"></script>
